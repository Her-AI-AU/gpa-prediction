            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setNewAssessment({
                    ...newAssessment,
                    totalWeighted: parseInt(e.target.value) || 0,
                  })
                }
              />
            </div>
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setNewAssessment({
                    ...newAssessment,
                    fullMark: parseInt(e.target.value) || 100,
                  })
                }
              />
            </div>
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setNewAssessment({
                    ...newAssessment,
                    minPassRequirement: parseInt(e.target.value) || 0,
                  })
                }
              />
            </div>
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setNewAssessment({
                    ...newAssessment,
                    scoreGained: parseInt(e.target.value) || 0,
                  })
                }
              />
            </div>
